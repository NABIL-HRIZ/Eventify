...
const menuItems = [
  { icon: <FaTachometerAlt />, label: 'Dashboard Accueil', path: '/user' },
  { icon: <FaUser />, label: 'Mes Informations', path: '/user/profile' },
  { icon: <FaCalendarAlt />, label: 'Mes Achats', path: '/user/achats' },
